...
+ Cloud - The infrastructure everything runs on
 ...
 each layer builds upon the security of the inner layers, protecting one layer does not
garantee the previous layer, does not matter if my code its secure if my container is a swiss chesse of breaches
